...
<section class="section">
    <div class="section-header">
      ...
      <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item"><a href="{{ url('/staff/dashboard/book') }}">Data Book</a></div>
        ...
        <div class="card">
            <form class="needs-validation" method="POST" enctype="multipart/form-data">
                ...
                @if(isset($book) && $book->cover)
                    <img id="preview" src="{{ asset('storage/book-covers/' . $book->cover) }}" alt="Preview" style="max-width: 200px; margin-top: 10px;">
                @else
                ...
                <div class="card-footer text-right">
                  <a href="{{ url('/staff/dashboard/book') }}" class="btn btn-secondary">Back</a>
